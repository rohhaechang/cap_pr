...
export default async function ItemDetails({params}: {params: {company_cik: number}}) {
  ...
  return (
      ...
      <h1>{items.name}</h1>
      <details>
        <summary><text style={{ fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>요약 보기</text></summary>
          <p>{items.summary}</p>
      </details>
      <details>
        <summary><text style={{ fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item1 보기</text></summary>
        <div>
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_2 보기</text></summary>
          <div>
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_3 보기</text></summary>
        <div>
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_5 보기</text></summary>
        <div>
            {item_5['summary'] ? <p><b>stock summary:</b> {item_5['summary']}</p> : <p>stock summary: none</p>}
          </div>
      </details>
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_7 보기</text></summary>
        <div>
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_7a 보기</text></summary>
        <div>
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold", paddingTop: "10px"}}>item_8 보기</text></summary>
        <div>
        {item_8 != 'error'
