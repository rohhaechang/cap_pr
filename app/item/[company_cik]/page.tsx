...
export default async function ItemDetails({params}: {params: {company_cik: number}}) {
  ...
  return (
      ...
      <details>
        <summary><text style={{fontSize: "28px", fontWeight: "bold"}}>item1 보기</text></summary>
        <div>
